...
#  if !defined(__CURSES__)
  ...
  void
    keyboard_read(unsigned char *const o_scan, unsigned char *const o_ascii);
...
#      pragma aux keyboard_read                                               \
        = "mov esi, eax"                                                      \
          ...
          "int 16h"                                                           \
          "mov [byte ptr esi], ah"                                            \
          "mov [byte ptr ecx], al" parm[eax][ecx] modify[esi];
...
#      pragma aux keyboard_read                                               \
        = "mov si, ax"                                                        \
          ...
          "mov [byte ptr si], ah"                                             \
          "mov si, cx"                                                        \
          "mov [byte ptr si], al" parm[ax][cx] modify[si];
