...
#endif
// ALLEGRO:
#ifdef FL_CFG_GFX_ALLEGRO
bool Fl::cfg_gfx_allegro= 1;
#else
bool Fl::cfg_gfx_allegro= 0;
#endif
...
#endif
// ALLEGRO:
#ifdef FL_CFG_WIN_ALLEGRO
bool Fl::cfg_win_allegro= 1;
#else
...
#endif
// ALLEGRO:
#ifdef FL_CFG_SYS_ALLEGRO
bool Fl::cfg_sys_allegro= 1;
#else
bool Fl::cfg_sys_allegro= 0;
#endif
...
#else
// ALLEGRO: flush last to first
static void _flush(Fl_X *i)
{
    do
    {
...
static int flush_propogate(Fl_X *i)
{
    int dirty = 0;
