...
extern void
  kv3_dict_row_set_external(struct kv3_dict_row *const io_row)
{
  ...
  do
    {
      ...
      do
        {
          if (kv3_dict_row_cell_count <= l_slot)
            {
              break;
            }

          memset(l_cell, 0, sizeof(*l_cell));
      ...
      l_cell = &(*io_row).m_cell[(kv3_dict_row_cell_count - 1)];
